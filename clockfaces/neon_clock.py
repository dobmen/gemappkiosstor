...
from PyQt6.QtGui import QFont, QPainter, QPainterPath, QColor, QGuiApplication
...
class NeonClock(QWidget):
    ...
    def sizeHint(self):
        # Dynamically adapt to 1024x600, 1920x1200, or any active resolution
        screen = QGuiApplication.primaryScreen()
        return screen.size() if screen else QSize(1024, 600)
